...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 24, 2019 at 07:36 AM
...
(71, 1, '2019-09-24', 3, 14, 0),
(70, 1, '2019-09-24', 3, 14, 0),
(69, 1, '2019-09-24', 2, 14, 0),
(67, 1, '2019-09-24', 2, 14, 0);
...
--
-- Table structure for table `sellerclients`
--

DROP TABLE IF EXISTS `sellerclients`;
CREATE TABLE IF NOT EXISTS `sellerclients` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sellerclients`
--

INSERT INTO `sellerclients` (`Id`, `SellerId`, `ClientId`, `State`) VALUES
(1, 14, 2, 0),
(2, 14, 3, 0);
...
(14, 'Cesy Banegas', 2, 2, '0204199976337', 'cesy', 'cesy@gmail.com', '39540483', 'd51844846d55fc5d30bb6eb39b3759697d9b77ef', 3, 0, 0),
