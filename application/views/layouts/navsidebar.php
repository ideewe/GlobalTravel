    ...
    <div class="sidebar-content">
            ...
            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                ...
                <div class="content-header-item">
                    <a class="link-effect font-w700" href="index.html">
                        ...
                        <span class="font-size-xl text-dual-primary-dark">ideewe</span><span class="font-size-xl text-primary"></span>
                    </a>
                </div>
                <!-- END Logo -->
            </div>
            ...
            <div class="sidebar-mini-hidden-b text-center">
                ...
                <ul class="list-inline mt-10">
                    <li class="list-inline-item">
                        <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="be_pages_generic_profile.html"><?php echo $this->session->userdata("nombre") ?></a>
                    </li>
                    <li class="list-inline-item">
        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                ...
                <li>
                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-badge"></i><span class="sidebar-mini-hide">Mantenimiento</span></a>
                    <ul>
                        <?php if ($this->session->userdata("rol_id") == "1") : ?>
                        <li>
                            <a href="<?php echo base_url() ?>mantenimiento/usuarios/userlist">Usuarios eliminados</a>
                        </li>
                        <?php endif; ?>
                        <?php if ($this->session->userdata("rol_id") <= "2") : ?>
                        <li>
                            <a href="<?php echo base_url() ?>mantenimiento/usuarios">Usuarios</a>
                        </li>
                        <?php endif; ?>
                        <?php if ($this->session->userdata("rol_id") <= "3") : ?>
                        <li>
                            <a href="<?php echo base_url() ?>mantenimiento/Packages">Paquetes</a>
                        </li>
                        <?php endif; ?>
                        <?php if ($this->session->userdata("rol_id") == "3") : ?>
                        <li>
            ...
            <li class="open">
                ...
                <ul>
                    ...
                    <li>
                        <a class="active" href="be_pages_generic_blank_breadcrumb.html">Blank (Breadcrumb)</a>
                    </li>
                    <li>
