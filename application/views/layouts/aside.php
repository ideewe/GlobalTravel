                ...
                <div class="content-header content-header-fullrow">
                    <div class="content-header-section align-parent">
                        ...
                        <div class="content-header-item">
                            ...
                            <a class="align-middle link-effect text-primary-dark font-w600" href="be_pages_generic_profile.html"><?php echo $this->session->userdata("nombre")?></a>
                        </div>
                        <!-- END User Info -->
                    </div>
                </div>
                ...
                <div class="content-side">
                            ...
                            <ul class="nav-users push">
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="<?php echo base_url();?>assets/media/avatars/avatar6.jpg" alt="">
                    ...
                    <div class="block pull-r-l">
                        ...
                        <?php if ($this->session->flashdata("error")):?>
                                ...
                                <?php endif;?>
                            <form action="<?php echo base_url();?>signup/update" method="post" >
                            <input type="hidden" name="rol_id" value="<?php echo $this->session->userdata("rol_id")?>">
                            <input type="hidden" name="id" value="<?php echo $this->session->userdata("id")?>">
                            <input type="hidden" name="GenderId" value="<?php echo $this->session->userdata("genero")?>">
                                <div class="form-group mb-15">
                                    <label for="name">Nombre</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Your name.." value="<?php echo $this->session->userdata("nombre")?>">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group mb-15">
                                    <label for="identity">Numero de Identidad</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="identity" name="identity" placeholder="Your Id Number.." value="<?php echo $this->session->userdata("identidad")?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="fa fa-user"></i>
                                            </span>
                                ...
                                <div class="form-group mb-15">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Your username.." value="<?php echo $this->session->userdata("user")?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="fa fa-user"></i>
                                            </span>
                                ...
                                <div class="form-group mb-15">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Your email.." value="<?php echo $this->session->userdata("email")?>">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                ...
                                <div class="form-group mb-15">
                                    <label for="side-overlay-profile-password">Nueva Contraseña</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group mb-15">
                                    <label for="side-overlay-profile-password-confirm">Confirmar Nueva Contraseña</label>
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="password-confirm" name="confirmpassword" placeholder="Confirmar Nueva Contraseña..">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="fa fa-asterisk"></i>
                                            </span>
