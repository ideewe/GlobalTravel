...
<div class="block">
    ...
    <div class="block-content tab-content overflow-hidden">
        ...
        <div class="tab-pane fade fade-left" id="Tarjeta" role="tabpanel">
            ...
            <?php else : ?>
                <h5>El Usuario no Cuenta con Tarjetas de Credito/Debito</h5>
            <?php endif; ?>
        </div>
        <div class="tab-pane fade fade-left" id="Contacto" role="tabpanel">
            ...
            <?php else : ?>
                <h5>La informacion de contacto del Usuario no esta disponible</h5>
            <?php endif; ?>
        </div>
        <div class="tab-pane fade fade-left" id="Membresia" role="tabpanel">
            ...
            <?php else : ?>
                <h5>El usuario no posee una Membresia</h5>
            <?php endif; ?>
        </div>
        <div class="tab-pane fade fade-left" id="Observaciones" role="tabpanel">
                            ...
                            <?php if (!empty($Observacion)) : ?>
                                <?php foreach ($Observacion as $Ob) : ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell"><?php if ($Ob->State == 0) {
                                                                                            echo "Activa";
                                                                                        } else {
                                                                                            echo "Inactiva";
                                                                                        } ?></td>
            ...
            <?php else : ?>
                <h5>El Usuario no tiene Observaciones</h5>
            <?php endif; ?>
        </div>
        <div class="tab-pane fade fade-left" id="Operaciones" role="tabpanel">
                                            ...
                                            <?php foreach ($Vendedores as $Vendedor) : ?>
                                                <?php if ($MiPaquete->SellerId == $Vendedor->IdUser) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="font-w600"><?php if ($MiPaquete->State == 0) {
                                                                                                                echo "Activa";
                                                                                                            } else {
                                                                                                                echo "Inactiva";
                                                                                                            } ?></td>
            ...
            <?php elseif ($Usuario->rol_id == 3 and !empty($SusPaquetes)) : ?>
                <div class="block-content block-content-full">
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php if (!empty($Paquetes)) : ?>
                                <?php foreach ($SusPaquetes as $SuPaquete) : ?>
                                    <?php foreach ($Paquetes as $Paquete) : ?>
                                        <?php if ($SuPaquete->PackageId == $Paquete->Id) : ?>
                                            <?php foreach ($Vendedores as $Cliente) : ?>
                                                <?php if ($SuPaquete->ClientId == $Cliente->IdUser) : ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $SuPaquete->Id; ?></td>
                                                        <td class="font-w600"><?php echo $Paquete->Name; ?></td>
                                                        <td class="font-w600"><?php echo $Cliente->FullName; ?></td>
                                                        <td class="d-none d-sm-table-cell"><?php echo $Paquete->Price; ?></td>
                                                        <td class="d-none d-sm-table-cell"><?php echo $SuPaquete->Date; ?></td>
                                                        <td class="font-w600"><?php if ($SuPaquete->State == 0) {
                                                                                                                echo "Activa";
                                                                                                            } else {
                                                                                                                echo "Inactiva";
                                                                                                            } ?></td>
            ...
            <?php else : ?>
                <h5>El Usuario no cuenta con Operaciones realizadas</h5>
            <?php endif; ?>
        </div>
